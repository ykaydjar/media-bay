    ...
    return(
        <div style={{display: 'flex', flexDirection: 'column', width: '100vw',}}>
            ...
            <div style={{width: '100%', height: '85%', minWidth: 360, display: menuShown?'none':'flex',  flexWrap: 'wrap', justifyContent: 'center', flexDirection: 'column',  marginBottom: 30, overflowX: 'hidden'}}>
                <TweenOne
                    key='left-block'
                    style={{display: menuShown?'none':'flex', paddingTop: 10, paddingBottom: 10, transform: 'translateX(-100vw)', boxShadow: zkBoxShadow, minWidth: 360, opacity: 0, width: '100vw',  height: '40em', flexDirection: 'column', overflowX: 'hidden', justifyContent: 'center', alignItems: 'center'}}
